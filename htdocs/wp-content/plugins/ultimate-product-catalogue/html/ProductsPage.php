...
<?php 
			...
			$Sql = "SELECT * FROM $items_table_name WHERE 1=1 ";
				...
				if (isset($_GET['OrderBy'])) {$Current_Page_With_Order_By .= $Current_Page_With_Name_Search . "&OrderBy=" .$_GET['OrderBy'] . "&Order=" . $_GET['Order'];}
				else {$Current_Page_With_Order_By = $Current_Page_With_Name_Search;}
?>
